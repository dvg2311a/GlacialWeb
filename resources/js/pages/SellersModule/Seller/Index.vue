            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class=" overflow-hidden sm:rounded-lg">
                    <div class="p-1 border-gray-200">
                        ...
                        <p class=":dark:text-white">En este apartado puedes gestionar los vendedores.
                            Agregar, ver y eliminar cada registro.</p>
                    </div>
                </div>

                <div class="mt-6 max-w-7xl mx-auto sm:px-6 lg:px-8 flex justify-end">
                    <NavLink :href="route('sellers.create')"
                ...
                <div class=" bg-white mt-6 -ml-4 overflow-auto w-[428px] lg:w-full lg:p-0 lg:overflow-hidden pr-4 pb-4 scrollbar-thin scrollbar-thumb-gray-400"
                    ...
                    <table class="min-w-[0px] lg:w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="item in seller" :key="item.id">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    {{ item.cart?.plate_number ?? '-' }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <NavLink :href="route('sellers.show', item.id)"
                                        class="text-green-600 hover:text-green-900 dark:text-green-600"
                                        title="Ver">
                                        <Eye class="edit" />
                                    </NavLink>
                                    <NavLink :href="route('sellers.edit', item.id)"
