...
function confirmDelete(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            router.delete(route('flavor_products.destroy', id));
            Swal.fire(
                '¡Eliminado!',
                'El sabor de producto ha sido eliminado.',
                'success'
            );
        }
    });
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class=" overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-1 ml-4">
                        <h1 class="text-2xl font-bold mb-4">Sabores de Productos</h1>
                        <p class="dark:text-white">En este apartado puedes gestionar los sabores de productos.
                ...
                <div class="mt-6 overflow-auto w-[365px] lg:w-full lg:p-0 lg:overflow-hidden pr-4 pb-4 scrollbar-thin scrollbar-thumb-gray-400"
                    ...
                    <table class="min-w-[0px] lg:w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="flavor_product in flavor_product" :key="flavor_product.id">
