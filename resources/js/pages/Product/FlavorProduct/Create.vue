...
const submit = () => {
    form.post(route('flavor_products.store'), {
        onSuccess: () => {
            Swal.fire({
                title: '¡Éxito!',
                text: 'El sabor de producto ha sido creado exitosamente.',
                icon: 'success',
...
<template>
    ...
    <Head title="Crear Sabor de Producto" />
    <AuthenticatedLayout>
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200 flex flex-wrap">
                        ...
                        <p class="text-gray-600 w-full mt-4">En este apartado puedes crear un nuevo sabor de producto.
                        </p>
                    </div>
                </div>

                <!-- Formulario para crear un nuevo sabor de producto -->
