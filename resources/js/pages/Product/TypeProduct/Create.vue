...
const submit = () => {
    form.post(route('type_products.store'), {
        onSuccess: () => {
            Swal.fire({
                title: '¡Éxito!',
                text: 'El tipo de producto ha sido creado exitosamente.',
                icon: 'success',
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class=" overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-1 ml-4 flex flex-wrap">
                        ...
                        <h1 class="text-2xl font-bold mt-1">Crear Tipo de Producto</h1>
                        <p class="dark:text-white w-full mt-4">En este apartado puedes crear un nuevo tipo de producto.
                        </p>
                    </div>
                </div>

                <!-- Formulario para crear un nuevo tipo de producto -->
