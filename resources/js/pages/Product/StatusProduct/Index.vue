                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="status_product in status_products" :key="status_product.id">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <NavLink :href="route('status_products.edit', status_product.id)" class="text-indigo-600 hover:text-indigo-900" title="Editar">
                                        <SquarePen />

                                    </NavLink>
                                    <button @click="confirmDelete(status_product.id)" class="text-red-600 hover:text-red-900 ml-2 " title="Eliminar">
                                        <Trash />
