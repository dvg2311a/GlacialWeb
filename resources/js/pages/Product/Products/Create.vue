            ...
            <div class="w-full mx-auto lg:px-8 ">
                <div class=" overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-1 ml-4 flex flex-wrap">
                        ...
                        <h1 class="text-2xl font-bold mt-1">Crear Producto</h1>
                        <p class="dark:text-white w-full mt-4">En este apartado puedes crear un nuevo producto.</p>
                    </div>
                </div>
                    ...
                    <form @submit.prevent="submit"
                        ...
                        <div>
                            <label for="flavor_id" class="block text-sm font-medium text-gray-700">Sabor del
                                Producto</label>
                            <select v-model="form.flavor_id" name="flavor_id" id="flavor_id"
                                required
                                class="mt-1 block w-80 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            ...
                            <div v-if="form.flavor_id" class="text-red-600 text-sm mt-1">{{
                                form.errors.flavor_id }}</div>
                        </div>
                        <div>
                            <label for="status_product_id" class="block text-sm font-medium text-gray-700">Estado del
                                Producto</label>
