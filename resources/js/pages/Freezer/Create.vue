            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="overflow-hidden shadow-sm sm:rounded-lg">
                    <div class=" ml-4 p-1 flex flex-wrap">
                        ...
                        <h1 class="text-2xl font-bold mt-1">Crear Freezer</h1>
                        <p class="dark:text-white w-full mt-4">En este apartado puedes crear un nuevo freezer.</p>
                    </div>
                </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-6 flex justify-center flex-col items-center">
                        ...
                        <div>
                            ...
                            <select v-model="form.status" name="description" id="description" rows="3"
                                ...
                                <option value="activo dañado">Activo dañado</option>
