...
function submit() {
	form.post(route('status_carts.store'), {
		onSuccess: () => {
			Swal.fire({
				title: '¡Éxito!',
				text: 'El estado de carrito ha sido creado exitosamente.',
				icon: 'success',
...
<template>
	...
	<Head title="Crear Estado de Carrito" />
	<AuthenticatedLayout>
		<div class="py-2 ">
			<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
				<div class="overflow-hidden  sm:rounded-lg">
					<div class="ml-4 py-1 border-gray-200 flex flex-wrap">
						...
						<h1 class="text-2xl font-bold mt-1">Crear Estado de Carrito</h1>
						<p class="dark:text-white w-full mt-4">En este apartado puedes crear un nuevo estado de carrito.</p>
					</div>
				</div>
